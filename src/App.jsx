...
import { getPlanetScenePos, getMissionScenePos, getMoonScenePos } from './utils/orbits';
...
export default function App() {
  ...
  // Expose live missions to orbits.js positioning fallback
  useEffect(() => {
    window.__ISRO_MISSIONS__ = missions;
  }, [missions]);
